    ...
    <div className="min-h-dvh bg-paper px-5 py-10">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted">
          The Grade 11 Pre-Engineering cohort is already loaded. Students and teachers are linked
          to an existing register so you can see real attendance, assignments and results immediately.
        </p>
